  ...
  function add_squares() {
	...
	$("#get_deg_btn").click(function(){
   	...
   	if (samples_chosen.length == 2) {
  	    document.getElementById("degOutput").innerHTML = "";

  	    document.getElementById("degNewPlot").style.display="block";
  	    document.getElementById("degGetPlot").style.display="none";
  	    document.getElementById("degOutput").style.display="block";
  	    document.getElementById("degSelector").style.display="none";
  	    document.getElementById("deg_new_plot_btn").style.display="block";
  	    document.getElementById("get_deg_btn").style.display="none";
  	    document.getElementById("deg_instruction").style.display="none";
...
//					},
	...
	if (!deg_loaded) {
	    document.getElementById("degNewPlot").style.display="none";
	    document.getElementById("degGetPlot").style.display="block";
	    document.getElementById("degSelector").style.display="block";
	    document.getElementById("degOutput").style.display="none";
	    document.getElementById("deg_new_plot_btn").style.display="none";
	    document.getElementById("Scatter_error_modal").style.display="none";
	    document.getElementById("degSelector").style.height="1000";
	    document.getElementById("degSelector").style.width="850";
	    document.getElementById("degSelector").style.position ="relative";
...
//          width: 650,
  ...
  for (var y=1; y<=temp_array_length; y++) {
	...
	$("#degNewPlot").click(function(){
	    ...
	    document.getElementById("deg_new_plot_btn").style.display="none";
	    document.getElementById("degGetPlot").style.display="block";
	    document.getElementById("get_deg_btn").style.display="block";
	    document.getElementById("deg_instruction").style.display="block";
	});
