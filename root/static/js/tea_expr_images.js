...
//    alert("IMAGE DATA: "+img_name+" "+stage_name);
  var next_img_width;
  var prev_img_width;
  ...
  if (stage_h[stage_ids_a[n-1]]) {
    prev_img_width = stage_h[stage_ids_a[n-1]]["image_width"]*1
  }
  else {
    prev_img_width = 0;
  }
...
//    alert('go over images... '+stage_ids_a.length);
...
//    alert('loading tissue images. '+image_name);
